              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="no_nota" id="no_nota" class="form-control form-control-sm" value="1">
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <button id="add_cart" type="submit" class="btn btn-success"><i class="fa fa-cart-plus"></i> Update Stock</button>
              </div>
              <?php echo form_close() ?>
