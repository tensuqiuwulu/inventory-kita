      ...
      <div class="col-8">
        <div class="card card-red" style="margin: 10px;">
          <div class="card-header">
            <h3 class="card-title">Form Input Vendor</h3>
          </div>
          <?php echo form_open_multipart('create_vendor', 'id="validasi_create_vendor"') ?>
          <div style="margin: 14px">
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
                  <label style="font-weight: normal;" for="nama_vendor">Nama Vendor</label>
                  <input type="text" name="nama_vendor" id="nama_vendor" class="form-control form-control-sm">
                </div>
                <div class="col-md-6">
                  <label style="font-weight: normal;" for="no_tlp">Telepon</label>
                  <input type="text" name="no_tlp" id="no_tlp" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" name="bidang_usaha" id="bidang_usaha" class="form-control form-control-sm">
                </div>
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-6">
                      <label style="font-weight: normal;" for="no_npwp">No NPWP</label>
                      <input type="text" name="no_npwp" id="no_npwp" class="form-control form-control-sm" data-inputmask="'mask': ['99.999.999.9-999.999']" data-mask placeholder="00.000.000.0-000.000">
                    </div>
                    <div class="col-md-6">
                      <label style="font-weight: normal;" for="no_pic">No PIC</label>
                      <input type="text" name="no_pic" id="no_pic" class="form-control form-control-sm">
                    </div>
                  </div>
                </div>
              </div>
