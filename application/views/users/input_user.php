        ...
        <div class="card card-red" style="margin: 10px;">
          ...
          <div class="card-body">
            <div style="margin: 14px">
              <?php echo form_open('add_user', 'id="user_form"') ?>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4">
                    <label style="font-weight: normal;" for="nama_user">Nama Lengkap</label>
                    <input type="text" name="nama_user" id="nama_user" class="form-control form-control-sm" />
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <input name="text" id="no_hp" class="form-control form-control-sm" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4">
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <input type="text" name="kode_kantor" id="kode_kantor" class="form-control form-control-sm" placeholder="000" />
                      </div>
                      <div class="col-md-4">
                      ...
                      <div class="col-md-5">
                        ...
                        <select name="id_divisi" id="id_divisi" class="form-control form-control-sm divisi"></select>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="password" name="cek_password" id="cek_password" class="form-control form-control-sm">
                  </div>
                </div>
              </div>
              <div class="form-group">
