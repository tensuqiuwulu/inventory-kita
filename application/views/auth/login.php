...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_admin/plugins/toastr/toastr.min.css">
</head>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="<?= base_url('authentication') ?>" class="login100-form validate-form" method="post" id="validasi_login">
