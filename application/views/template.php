...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed text-sm">
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-dark navbar-green">
      <form class="form-inline ml-3">
        <div class="input-group input-group-sm">
          <span class="brand-text font-weight-bold" style="color: #ffffff;">PT. BPR Kita Centradana</span>
        </div>
      </form>
    ...
    <aside class="main-sidebar sidebar-light-green elevation-4">
      <a href="index3.html" class="brand-link navbar-green">
        ...
        <span class="brand-text font-weight-bold" style="color: #ffffff; margin-left:10px">INVENTORY KITA</span>
      </a>
      <div class="sidebar">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview <?php if ($page == 'kategori' || $page == 'vendor' || $page == 'divisi' || $page == 'users') echo "menu-open"; ?>">
              <a href="#" class="nav-link <?php if ($page == 'kategori' || $page == 'vendor' || $page == 'divisi' || $page == 'users') echo "active"; ?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= base_url('divisi') ?>" class="nav-link <?php if ($page == 'divisi') echo "active"; ?>">
                    <i class="fas fa-users nav-icon"></i>
                    <p>Divisi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= base_url('users') ?>" class="nav-link <?php if ($page == 'users') echo "active"; ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="<?= base_url("list_permintaan_barang") ?>" class="nav-link <?php if ($page == 'permintaan') echo "active"; ?>">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 IT PT. BPR Kita Centradana</strong>
    All rights reserved.
